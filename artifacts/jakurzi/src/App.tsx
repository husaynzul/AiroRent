...
function DetailPage({ id }: { id: string }) {
  ...
  return <main className="mx-auto max-w-[1260px] px-5 pb-32 pt-5 md:pb-36 lg:px-8">
    ...
    <div className="hidden md:block">
     ...
     <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[hsl(var(--border))] bg-[hsl(var(--card)/.97)] px-4 py-3 shadow-[0_-8px_24px_rgba(22,28,35,.08)] backdrop-blur-xl" data-testid="property-action-bar"><div className="mx-auto flex max-w-[1260px] items-center gap-2 md:gap-3"><button onClick={() => openWhatsApp(listing)} className="flex min-h-12 flex-1 items-center justify-center gap-2 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] px-3 text-sm font-bold transition hover:bg-[hsl(var(--secondary))]" data-testid="button-property-whatsapp"><MessageCircle size={21} strokeWidth={2.5} /><span>WhatsApp</span></button><button onClick={toggleSave} className={`flex min-h-12 flex-1 items-center justify-center gap-2 rounded-2xl border px-3 text-sm font-bold transition ${saved ? 'border-[hsl(var(--foreground))] bg-[hsl(var(--secondary))]' : 'border-[hsl(var(--border))] bg-[hsl(var(--card))] hover:bg-[hsl(var(--secondary))]'}`} data-testid="button-property-save"><Heart size={21} strokeWidth={2.5} fill={saved ? 'currentColor' : 'none'} /><span>{saved ? 'Saved' : 'Save'}</span></button><button onClick={openBooking} className="flex min-h-12 flex-[1.2] items-center justify-center gap-2 rounded-2xl bg-[hsl(var(--primary))] px-4 text-sm font-bold text-white shadow-soft transition hover:-translate-y-0.5" data-testid="button-property-book"><CalendarDays size={21} strokeWidth={2.5} /><span>Book</span></button></div></div>
