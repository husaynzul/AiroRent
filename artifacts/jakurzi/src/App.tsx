  ...
  return <main className="mx-auto max-w-[1260px] px-5 pb-32 pt-5 md:pb-36 lg:px-8">
    <div className="md:hidden">
      ...
      <section className="relative -mx-5 -mt-7 rounded-t-[30px] bg-white px-6 pb-28 pt-7">
        ...
        <section className="mt-8 border-t border-black/[.1] pt-7" data-testid="section-host-details"><h2 className="text-[21px] font-bold">Meet your hosts</h2><div className="mt-4 space-y-4"><div className="flex items-center gap-3"><div className="grid size-12 place-items-center rounded-full bg-[hsl(var(--accent))] text-lg font-bold text-[hsl(var(--primary))]">M</div><div><p className="font-bold">Maria Camilleri</p><p className="text-xs text-black/55">Host · Verified owner · 6 years hosting</p></div><ShieldCheck className="ml-auto text-[hsl(var(--primary))]" size={20} /></div><div className="flex items-center gap-3"><div className="grid size-12 place-items-center rounded-full bg-[hsl(var(--secondary))] text-lg font-bold text-[hsl(var(--primary))]">S</div><div><p className="font-bold">Sofia Attard</p><p className="text-xs text-black/55">Co-host · Helps with check-in and support</p></div><UsersRound className="ml-auto text-[hsl(var(--primary))]" size={20} /></div></div><button onClick={() => setContactOpen(true)} className="mt-5 rounded-xl border border-black/15 px-4 py-2.5 text-sm font-bold" data-testid="button-contact-hosts">Contact the hosts</button></section>
        <section className="mt-8 border-t border-black/[.1] pt-7" data-testid="section-cancellation"><h2 className="text-[21px] font-bold">Cancellation and booking</h2><p className="mt-3 text-sm leading-relaxed text-black/65">Review the dates, guests, house rules, and total before requesting to book. Your payment stays protected until the host confirms.</p><p className="mt-3 flex items-center gap-2 text-sm font-semibold"><ShieldCheck size={18} className="text-[hsl(var(--primary))]" />Free cancellation before the host confirms</p></section>
         <section className="mt-8 rounded-[25px] border border-[hsl(var(--primary)/.2)] bg-[hsl(var(--secondary)/.55)] p-5" data-testid="section-booking"><div className="flex items-end justify-between"><div><p className="text-[11px] font-bold uppercase tracking-[.12em] text-[hsl(var(--primary))]">Ready to book?</p><p className="mt-1 text-[24px] font-bold">{listing.price}<span className="ml-1 text-sm font-normal text-black/55">{listing.mode === 'Short Let' ? '/ night' : ''}</span></p><p className="text-xs text-black/55">Total before taxes</p></div><LockKeyhole size={22} className="text-[hsl(var(--primary))]" /></div><button onClick={openBooking} className="mt-5 w-full rounded-2xl bg-[hsl(var(--primary))] py-4 text-[16px] font-bold text-white" data-testid="button-detail-check-availability-mobile">{listing.mode === 'Buy' ? 'Make an offer' : 'Start booking'}</button><p className="mt-3 text-center text-xs text-black/55">You will not be charged until the owner confirms.</p></section>
      </section>
    </div>
    <div className="hidden md:block">
     ...
     <section className="mx-auto mt-10 hidden max-w-[820px] border-t border-[hsl(var(--border))] pt-8 md:block" data-testid="section-desktop-reviews"><div className="flex items-start justify-between gap-4"><div><h2 className="font-display text-3xl">Reviews</h2><p className="mt-2 flex items-center gap-2 text-sm font-semibold"><Star size={19} fill="currentColor" />{listing.rating} · 18 reviews</p></div><button onClick={() => setToast('Showing all reviews')} className="text-sm font-bold underline" data-testid="button-desktop-show-reviews">See all</button></div><blockquote className="mt-5 rounded-2xl bg-[hsl(var(--secondary)/.55)] p-5 text-sm leading-relaxed">“Beautifully kept, quiet, and exactly as described. Maria made the whole stay feel easy.”<footer className="mt-3 text-xs font-semibold text-[hsl(var(--muted-foreground))]">— Elena · Stayed 2 weeks</footer></blockquote></section>
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[hsl(var(--border))] bg-[hsl(var(--card)/.98)] px-3 py-2.5 shadow-[0_-10px_30px_rgba(22,28,35,.12)] backdrop-blur-xl sm:px-4 sm:py-3" data-testid="property-action-bar"><div className="mx-auto flex max-w-[1260px] items-center gap-2 sm:gap-3 md:gap-5"><div className="min-w-0 flex-1"><div className="flex min-w-0 items-center gap-2.5 sm:gap-3"><div className="grid size-10 shrink-0 place-items-center rounded-full bg-[hsl(var(--accent)/.55)] text-base font-bold text-[hsl(var(--primary))] sm:size-12 sm:text-lg">M</div><div className="min-w-0"><p className="truncate text-sm font-bold sm:text-base">Maria Camilleri</p><p className="hidden truncate text-[11px] text-[hsl(var(--muted-foreground))] sm:block">Verified owner · 6 years on AiroRent</p></div></div><div className="mt-1.5 flex items-baseline gap-1.5 pl-[50px] sm:mt-2 sm:pl-[60px]"><span className="hidden text-[10px] font-bold uppercase tracking-wider text-[hsl(var(--muted-foreground))] sm:inline">Total price</span><span className="text-lg font-extrabold leading-none text-[hsl(var(--brand-accent))] sm:text-2xl">{listing.price}</span><span className="text-[11px] font-semibold text-[hsl(var(--muted-foreground))] sm:text-sm">{listing.mode === 'Short Let' ? '/ night' : listing.mode === 'Buy' ? 'total' : '/ month'}</span></div></div><div className="flex shrink-0 items-center gap-1.5 sm:gap-2"><button onClick={() => setContactOpen(true)} className="grid size-11 place-items-center rounded-full bg-[hsl(var(--brand-accent)/.1)] text-[hsl(var(--brand-accent))] transition hover:bg-[hsl(var(--brand-accent)/.18)] sm:size-14" aria-label="Message Maria" data-testid="button-property-message"><MessageCircle size={21} strokeWidth={2.8} className="sm:hidden" /><MessageCircle size={24} strokeWidth={2.8} className="hidden sm:block" /></button><button onClick={callHost} className="grid size-11 place-items-center rounded-full bg-[hsl(var(--brand-accent)/.1)] text-[hsl(var(--brand-accent))] transition hover:bg-[hsl(var(--brand-accent)/.18)] sm:size-14" aria-label="Call Maria" data-testid="button-property-call"><Phone size={21} strokeWidth={2.8} className="sm:hidden" /><Phone size={24} strokeWidth={2.8} className="hidden sm:block" /></button></div><button onClick={openBooking} className="min-h-12 flex-[.95] rounded-full bg-[hsl(var(--brand-accent))] px-3 text-[13px] font-extrabold text-white shadow-[0_8px_20px_hsl(var(--brand-accent)/.28)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_26px_hsl(var(--brand-accent)/.36)] sm:min-h-14 sm:flex-[1.15] sm:px-6 sm:text-lg" data-testid="button-property-book"><span>{listing.mode === 'Buy' ? 'Make offer' : 'Book Now'}</span></button></div></div>
    ...
    <div className="fixed inset-0 z-50 flex items-end animate-fade bg-[hsl(var(--foreground)/.4)] p-3 backdrop-blur-sm md:items-center md:justify-center" onClick={onClose}>
      <div className="w-full max-w-md animate-rise rounded-[28px] bg-[hsl(var(--card))] p-6 shadow-lift" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <button onClick={() => openWhatsApp(listing)} className="flex items-center justify-center gap-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] py-3 text-sm font-bold hover:bg-[hsl(var(--secondary))]" data-testid="button-contact-whatsapp"><MessageCircle size={20} strokeWidth={2.5} />WhatsApp</button>
        ...
        <button onClick={onSent} className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl bg-[hsl(var(--primary))] py-3.5 font-bold text-white" data-testid="button-send-message"><Send size={19} strokeWidth={2.5} />Send message</button>
