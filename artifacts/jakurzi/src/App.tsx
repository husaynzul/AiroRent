    ...
    <div className="fixed inset-0 z-50 flex items-end animate-fade bg-[hsl(var(--foreground)/.4)] p-3 backdrop-blur-sm md:items-center md:justify-center" onClick={onClose}>
      <div className="w-full max-w-md animate-rise rounded-[28px] bg-[hsl(var(--card))] p-6 shadow-lift" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <button onClick={() => openWhatsApp(listing)} className="flex items-center justify-center gap-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] py-3 text-sm font-bold hover:bg-[hsl(var(--secondary))]" data-testid="button-contact-whatsapp"><SiWhatsapp size={20} className="text-[#FA3B80]" />WhatsApp</button>
