  ...
  return <main className="mx-auto max-w-[1260px] px-5 pb-32 pt-5 md:pb-36 lg:px-8">
    ...
    <div className="hidden md:block">
     ...
     <section className="mx-auto mt-10 hidden max-w-[820px] border-t border-[hsl(var(--border))] pt-8 md:block" data-testid="section-desktop-reviews"><div className="flex items-start justify-between gap-4"><div><h2 className="font-display text-3xl">Reviews</h2><p className="mt-2 flex items-center gap-2 text-sm font-semibold"><Star size={19} fill="currentColor" />{listing.rating} · 18 reviews</p></div><button onClick={() => setToast('Showing all reviews')} className="text-sm font-bold underline" data-testid="button-desktop-show-reviews">See all</button></div><blockquote className="mt-5 rounded-2xl bg-[hsl(var(--secondary)/.55)] p-5 text-sm leading-relaxed">“Beautifully kept, quiet, and exactly as described. Maria made the whole stay feel easy.”<footer className="mt-3 text-xs font-semibold text-[hsl(var(--muted-foreground))]">— Elena · Stayed 2 weeks</footer></blockquote></section>
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[hsl(var(--border))] bg-[hsl(var(--card)/.98)] px-4 pb-[max(12px,env(safe-area-inset-bottom))] pt-3 shadow-[0_-10px_30px_rgba(22,28,35,.12)] backdrop-blur-xl sm:px-5 sm:py-3" data-testid="property-action-bar"><div className="mx-auto flex max-w-[1260px] flex-col gap-2.5 md:flex-row md:items-center md:gap-5"><div className="flex items-center justify-between gap-3 md:flex-1"><div className="flex min-w-0 items-center gap-2.5 sm:gap-3"><div className="grid size-10 shrink-0 place-items-center rounded-full bg-[hsl(var(--accent)/.55)] text-base font-bold text-[hsl(var(--primary))] sm:size-11 sm:text-lg">M</div><div className="min-w-0"><p className="truncate text-sm font-bold sm:text-base">Maria Camilleri</p><p className="hidden truncate text-[11px] text-[hsl(var(--muted-foreground))] sm:block">Verified owner · 6 years on AiroRent</p></div></div><div className="flex shrink-0 items-center gap-2"><button onClick={() => setContactOpen(true)} className="grid size-11 place-items-center rounded-full bg-[hsl(var(--brand-accent)/.1)] text-[hsl(var(--brand-accent))] transition hover:bg-[hsl(var(--brand-accent)/.18)] sm:size-12" aria-label="Message Maria" data-testid="button-property-message"><MessageCircle size={21} strokeWidth={2.8} /></button><button onClick={callHost} className="grid size-11 place-items-center rounded-full bg-[hsl(var(--brand-accent)/.1)] text-[hsl(var(--brand-accent))] transition hover:bg-[hsl(var(--brand-accent)/.18)] sm:size-12" aria-label="Call Maria" data-testid="button-property-call"><Phone size={21} strokeWidth={2.8} /></button></div></div><div className="flex min-w-0 items-center gap-3 md:flex-1 md:justify-end"><div className="min-w-0 flex-1"><span className="block text-[10px] font-bold uppercase tracking-wider text-[hsl(var(--muted-foreground))]">Total price</span><div className="mt-0.5 flex items-baseline gap-1.5"><span className="text-xl font-extrabold leading-none text-[hsl(var(--brand-accent))] sm:text-2xl">{listing.price.replace(' / mo', '')}</span><span className="text-[11px] font-semibold text-[hsl(var(--muted-foreground))] sm:text-sm">{listing.mode === 'Short Let' ? '/ night' : listing.mode === 'Buy' ? 'total' : '/ month'}</span></div></div><button onClick={openBooking} className="min-h-12 min-w-[132px] flex-[1.2] rounded-full bg-[hsl(var(--brand-accent))] px-5 text-[15px] font-extrabold text-white shadow-[0_8px_20px_hsl(var(--brand-accent)/.28)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_26px_hsl(var(--brand-accent)/.36)] sm:min-h-13 sm:min-w-[164px] sm:px-7 sm:text-lg" data-testid="button-property-book"><span>{listing.mode === 'Buy' ? 'Make offer' : 'Book Now'}</span></button></div></div></div>
