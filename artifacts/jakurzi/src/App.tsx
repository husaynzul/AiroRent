...
function PriceFilterGraphic() {
  ...
  return <section aria-labelledby="price-filter-title">
    ...
    <div className="relative mx-auto mt-2 h-[275px] w-full max-w-[760px] overflow-hidden sm:h-[420px]">
      ...
      <div className="absolute bottom-0 left-0 flex h-[58px] w-[112px] flex-col items-center justify-center rounded-[14px] border border-[#e7e7e7] bg-white px-2 text-center shadow-[0_2px_8px_rgba(0,0,0,.08)] sm:h-[76px] sm:w-[150px] sm:rounded-[18px]"><label className="block text-[12px] leading-tight text-[#777] sm:text-[14px]" htmlFor="minimum-price">Minimum</label><div className="mt-0.5 flex items-center justify-center text-[19px] leading-none font-semibold text-[#111] sm:text-[26px]"><span>$</span><input id="minimum-price" type="number" value={minimumInput} min={sliderMin} max={maximum - 1} onChange={(event) => editMinimum(event.target.value)} onBlur={() => setMinimumValue(Number(minimumInput))} className="w-[60px] appearance-none bg-transparent text-center outline-none sm:w-[83px]" aria-label="Minimum price" /></div></div>
      <div className="absolute bottom-0 right-0 flex h-[58px] w-[112px] flex-col items-center justify-center rounded-[14px] border border-[#e7e7e7] bg-white px-2 text-center shadow-[0_2px_8px_rgba(0,0,0,.08)] sm:h-[76px] sm:w-[150px] sm:rounded-[18px]"><label className="block text-[12px] leading-tight text-[#777] sm:text-[14px]" htmlFor="maximum-price">Maximum</label><div className="mt-0.5 flex items-center justify-center text-[19px] leading-none font-semibold text-[#111] sm:text-[26px]"><span>$</span><input id="maximum-price" type="number" value={maximumInput} min={minimum + 1} max={sliderMax} onChange={(event) => editMaximum(event.target.value)} onBlur={() => setMaximumValue(Number(maximumInput))} className="w-[60px] appearance-none bg-transparent text-center outline-none sm:w-[83px]" aria-label="Maximum price" /></div></div>
    </div>
  </section>;
}
